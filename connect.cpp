...
void Connect::stopUdpReceiver(){
    m_QUdpSocket->close();
    delete  m_QUdpSocket;
}


void Connect::processPendingDatagrams(){
...
QJsonObject Connect::findValueFromJsonArray(QJsonArray arr, QString key, int val) {
